...
cur = mysql.cursor()
cur.execute('''CREATE DATABASE BIMP3N;''')

cur.execute('''CREATE TABLE IF NOT EXISTS BIMP3N.Project_Name (
...
cur.execute('''CREATE TABLE IF NOT EXISTS BIMP3N.Project_Information(
