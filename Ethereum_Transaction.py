...
def Transaction(mqtt_data, S_Blkchain_ID):
    w3 = Web3(Web3.HTTPProvider("http://" + config['ETHEREUM_Node3']['host'] + ":" + config['ETHEREUM_Node3']['port']))
    w3.parity.personal.unlockAccount(w3.toChecksumAddress(config['ETHEREUM_Node3']['miner_account']), config['ETHEREUM_Node3']['miner_passwd'], 0)
